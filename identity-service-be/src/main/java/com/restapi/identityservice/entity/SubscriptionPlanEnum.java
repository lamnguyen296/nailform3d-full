...
public enum SubscriptionPlanEnum {
    ...
    STUDIO_5("B2B Studio (5 users)", 1999000, 5, "Studio license up to 5 members"),
    STUDIO_10("B2B Studio (10 users)", 2999000, 10, "Studio license up to 10 members"),
    ACADEMY_20("B2B Academy (20 users)", 4999000, 20, "Academy license up to 20 members");
